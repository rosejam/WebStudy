...
CREATE TABLE STARWARS (EPISODEID INT(5), EPISODENAME VARCHAR(50), OPENYEAR INT);
CREATE TABLE CHARACTERS (CHARACTERID INT(5), CHARACTERNAME VARCHAR(30), MASTERID INT(5), ROLEID INTEGER, EMAIL VARCHAR(40),
CONSTRAINT JEDICHECK CHECK (CHARACTERNAME ='제다이'));
CREATE TABLE CASTING (EPISODEID INT(5), CHARACTERID INT(5), REALNAME VARCHAR(30));
CREATE TABLE ROLES(ROLEID INTEGER, ROLENAME VARCHAR(30));
...
-- FK(PK지정후 해주자..)empcharacters
ALTER TABLE CASTING
ADD CONSTRAINT CASTING_CHARACTERID_FK FOREIGN KEY(CHARACTERID)
REFERENCES CHARACTERS(CHARACTERID);
ALTER TABLE CASTING
ADD CONSTRAINT CASTING_EPISODEID_FK FOREIGN KEY(EPISODEID)
REFERENCES STARWARS(EPISODEID);
ALTER TABLE CHARACTERS
ADD CONSTRAINT CASTING_ROLEID_FK FOREIGN KEY(ROLEID)
