...
public class Solution_SW_5658_보물상자비밀번호_서울9반_김동주_끝_ { 
	//중복되지 않게 넣을 때 set을 사용하지 않고 if(!list.contains(v)) 일 때만 add해도 된다!
...
//			System.out.println(M);
			...
			set = new HashSet<>();
			for(int n=0; n<M; n++) { //간단하게 4줄 중 첫번째 줄로 N번 돌리면 된다!
