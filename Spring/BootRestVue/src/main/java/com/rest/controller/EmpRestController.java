...
import com.vue.service.EmpService;
...
public class EmpRestController {
	...
	public List<Emp> findLikeEmps(@PathVariable String name){
		try {
	...
	public List<Emp> findEmpByMgrId(@PathVariable int managerId){
		try {
	...
	public List<Emp> findDeptByname(@PathVariable String name){
		try {
	...
	public List<Emp> findDeptBydeptid(@PathVariable int dept_id){
		try {
